...
class Debugger(object):
  def __init__(self, ipynb=False, theme='black', 
    ...
    elif num_classes == 1 or dataset == 'cccd':
      self.names = cccd_class_name
    elif num_classes == 4 or dataset == 'corner':
      self.names = corner_class_name
    elif num_classes == 8 or dataset == 'infor':
      self.names = infor_class_name
    elif dataset == 'gta':
...
cccd_class_name = ['cccd']

corner_class_name = ['top_left', 'top_right', 'bottom_left', 'bottom_right']

infor_class_name = ['id', 'hoten', 'ngaysinh', 'gioitinh', 'quoctich', 'quequan', 'thuongtru', 'giatri']
