...
ngpu = 2 # number of GPUs to use. Do remember to set multi_gpu to True!
workers = 0 # number of data loading workers

# training process
displayInterval = 966 # interval to be print the train loss
valInterval = 966 # interval to val the model loss and accuray
# saveInterval = 567 # interval to save model
